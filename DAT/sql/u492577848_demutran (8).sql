...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 30/12/2024 às 16:56
...
--
ALTER TABLE `DAT2`
  ADD KEY `DAT2_fk_formulario` (`token`);
...
ALTER TABLE `vehicle_damages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vehicle_damages_ibfk_1` (`user_vehicles_id`);
...
--
ALTER TABLE `DAT1`
  ADD CONSTRAINT `DAT1_fk_formulario` FOREIGN KEY (`token`) REFERENCES `formularios_dat_central` (`token`) ON DELETE CASCADE;

--
-- Restrições para tabelas `DAT2`
--
ALTER TABLE `DAT2`
  ADD CONSTRAINT `DAT2_fk_formulario` FOREIGN KEY (`token`) REFERENCES `formularios_dat_central` (`token`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `DAT4`
--
ALTER TABLE `DAT4`
  ADD CONSTRAINT `DAT4_ibfk_1` FOREIGN KEY (`token`) REFERENCES `formularios_dat_central` (`token`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `user_vehicles`
  ADD CONSTRAINT `user_vehicles_fk_formulario` FOREIGN KEY (`token`) REFERENCES `formularios_dat_central` (`token`) ON DELETE CASCADE ON UPDATE CASCADE;
