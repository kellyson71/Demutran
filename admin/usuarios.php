                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php echo htmlspecialchars($usuario['nome']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php echo htmlspecialchars($usuario['email']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php echo date('d/m/Y', strtotime($usuario['data_registro'])); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <button onclick="aceitarUsuario(<?php echo $usuario['id']; ?>)"
                                        class="text-green-600 hover:text-green-900 mr-4">Aceitar</button>
                                    <button onclick="recusarUsuario(<?php echo $usuario['id']; ?>)"
                                        class="text-red-600 hover:text-red-900">Recusar</button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
