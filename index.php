...
<body class="font-roboto bg-gray-100">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <p class="text-gray-600 text-center max-w-4xl mx-auto mb-8">
            O Departamento foi integrado ao sistema Nacional de Trânsito em 10 de fevereiro de 2022
            através da portaria nº 150/2022 da SENATRAN. Sendo o código do órgão autuador 21787-0.
        </p>
